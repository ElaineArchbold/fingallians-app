...
const WEEKS = [
  {
    ...
    skills:[
      {id:"h1a",label:"🏑 Ball Wall – Striking",desc:"20 mins: alternate striking off both sides, aim for below shoulder height. Count consecutive clean strikes.",youtube_id:"l93DPGnN0Uk"},
      {id:"f1a",label:"⚽ Ball Wall – Kick-Pass",desc:"20 mins: kick-pass off the wall, catch on the return. Focus on clean first touch. Try both feet.",youtube_id:"xqpmaUf1Ow4"},
    ],
  ...
  },
  {
    ...
    skills:[
      {id:"h2a",label:"🏑 Ground Ball Drill",desc:"20 mins: ground ball, first touch and lift immediately, flick to the wall. Build your speed and reactions.",youtube_id:"P0qD7mGLVgA"},
      {id:"f2a",label:"⚽ Solo Run Drill",desc:"Solo the ball 30m without dropping it. Try both feet. Count how many clean solos in a row — record your best!",youtube_id:"XduozZ--2-E"},
    ],
  ...
  },
  {
    ...
    skills:[
      {id:"h3a",label:"🏑 Free Taking – 21m",desc:"15 hurling frees from the 21. Count how many go over. Record your score — coaches will retest in September!",youtube_id:"pm5sdhJcd-Q"},
      {id:"f3a",label:"⚽ Scoring from the D",desc:"10 shots from different spots around the D. Count your score. Can you get 7+ out of 10?",youtube_id:"yuzVZPPanxU"},
    ],
  ...
  },
  {
    ...
    skills:[
      {id:"h4a",label:"🏑 Ball Wall – Combination",desc:"25 mins: overhead, ground and close-range striking mixed. No stopping to reset between touches.",youtube_id:"v4vDsKw-qow"},
      {id:"f4a",label:"⚽ Hand-Pass & Kick Combo",desc:"25 mins: fist-pass to wall, catch, kick-pass. Mix both feet and hands. Keep moving the whole time.",youtube_id:"FZS8TrvzOqw"},
    ],
  ...
  },
  {
    ...
    skills:[
      {id:"h5a",label:"🏑 45-Metre Free",desc:"5 attempts from the 45m line. Score out of 5. Repeat on the other side. Coaches will test this in September!",youtube_id:"pm5sdhJcd-Q"},
      {id:"f5a",label:"⚽ Solo & Score",desc:"Timed drill: solo 40m, turn, shoot. Record your time. Try to beat it by end of the week.",youtube_id:"XduozZ--2-E"},
    ],
  ...
  },
  {
    ...
    skills:[
      {id:"h6a",label:"🏑 Ball Wall – Match Speed",desc:"30 mins at full pace. Strike, receive, strike again. No slow touches. Do this AFTER a run for extra challenge.",youtube_id:"EZbQidktV3k"},
      {id:"f6a",label:"⚽ 3-Man Weave Drill",desc:"3 lads across the pitch, pass and follow your pass. Weave to goal, finish with a score. How many in 5 mins?",youtube_id:"B2O5iEgmZ94"},
    ],
  ...
  },
  {
    ...
    skills:[
      {id:"h7a",label:"🏑 Consecutive Frees",desc:"Most accurate hurling frees from 20m in a row without a miss. Personal best — beat it!",youtube_id:"cGKK8_rA5HU"},
      {id:"f7a",label:"⚽ Points from Both Feet",desc:"10 shots — 5 from left, 5 from right foot, 13m out. Count your score. Can you get 7+ out of 10?",youtube_id:"yuzVZPPanxU"},
    ],
  ...
  },
  {
    ...
    skills:[
      {id:"h8a",label:"🏑 Final Ball Wall Session",desc:"35 mins hurling — full pace, both sides, ground and overhead. Leave nothing in the tank. This is your last session before assessment!",youtube_id:"v4vDsKw-qow"},
      {id:"f8a",label:"⚽ Final Solo & Kick Test",desc:"Solo the ball 30m clean, both feet. Compare to your Week 2 score. Then kick for score — compare to Week 3. How far have you come?",youtube_id:"XduozZ--2-E"},
    ],
    ...
    <div className="admin-wrap">
      ...
      <div className="card" style={{marginTop:20}}>
        ...
        <div className="card-bd" style={{fontSize:13,color:"var(--mid)",lineHeight:1.7}}>
          ...
          Find the YouTube video, copy the ID after <code style={{background:"#f0f0f0",padding:"1px 5px",borderRadius:4}}>?v=</code> and replace the existing ID.
